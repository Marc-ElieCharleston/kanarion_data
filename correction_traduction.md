> **Ce qui est VIVANT ici : la section « Glossaire standardise » (stats, effets de statut,
> termes internes a ne JAMAIS montrer au joueur).** C'est la reference terminologique canonique
> citee par les `CLAUDE.md`. Les Phases 1 a 5 en bas sont le plan d'execution de fevrier 2026,
> conserve pour l'historique — ne pas s'en servir comme etat des lieux.
>
> Restaure le 2026-08-09 : le fichier avait ete retire par le commit `65f019e` ("moved") mais
> n'existait plus nulle part sur le disque, alors que les CLAUDE.md le citaient toujours.
